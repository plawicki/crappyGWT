...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "crap" because\n';
 ...
 * "/crap.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['crap'].superdevmode = true;

  var expectedSuffix = '/crap.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + crap + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:crap';
  var devModeSessionKey = '__gwtDevModeSession:crap';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/crap/crap.nocache.js';
  ...
  $wnd.__gwt_activeModules['crap'].canRedirect = true;
  $wnd.__gwt_activeModules['crap'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/crap?user.agent=' + ua + '&_callback=' + callback;
